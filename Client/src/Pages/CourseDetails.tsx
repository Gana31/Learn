...
import GetAvgRating from "../Services/GetAvgRating";
import RatingStars from "../Component/Common/RatingStars";
import CourseDetailsCard from "../Component/ProtectedRoutes/Course/CourseDetailPage/CourseDetailsCard";
import CourseAccordionBar from "../Component/ProtectedRoutes/Course/CourseDetailPage/CourseAccordionBar";
import { formatDate } from "../Services/formatDate";
import { useCapturePaymentMutation, useGetCourseDetailsMutation, useSendPaymentSuccessEmailMutation, useVerifyPaymentMutation } from "../Services/Operation/authApi";
...
function CourseDetails() {
  ...
  const [GetCourseDetails] = useGetCourseDetailsMutation();
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        // console.log("course details res: ", res.data.data.courseDetails);
  ...
  const handleAddToCart = () => {
    console.log("accesstoke from courseDatils",accessToken)
    console.log("courseDatils from courseDatils",response.data.courseDatils)
    if (accessToken) {
  ...
  const handleBuyCourse = () => {
    if (accessToken) {
      buyCourse([courseId], user, navigate, dispatch,CapturePayment,
      ...
      <div className="mx-auto box-content px-4 text-start text-richblack-5 lg:w-[1260px]">
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="max-w-[830px]">
            ...
            <div className="py-4">
              {courseContent?.map((course : any, index : any) => (
                <CourseAccordionBar
                  course={course}
                  key={index}
                  isActive={isActive}
