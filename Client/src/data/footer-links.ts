...
interface FooterLink2Interface {
  title : string;
  links : {
    title: string;
    link : string;
...
export const BottomFooter : string[] = ["Privacy Policy", "Cookie Policy", "Terms"];
...
export const Plans : string[] = ["Paid memberships", "For students", "Business solutions"];
export const Community : string[] = ["Forums", "Chapters", "Events"];


export const FooterLink2 : FooterLink2Interface []= [
  {
    title: "Subjects",
    links: [
      { title: "Al", link: "/al" },
