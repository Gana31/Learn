...
exports.verifyPayment = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    const razorpay_order_id = (_a = req.body) === null || _a === void 0 ? void 0 : _a.bodyData.razorpay_order_id;
    const razorpay_payment_id = (_b = req.body) === null || _b === void 0 ? void 0 : _b.bodyData.razorpay_payment_id;
    const razorpay_signature = (_c = req.body) === null || _c === void 0 ? void 0 : _c.bodyData.razorpay_signature;
    const courses = (_d = req.body) === null || _d === void 0 ? void 0 : _d.bodyData.courses;
